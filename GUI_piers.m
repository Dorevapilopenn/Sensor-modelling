function vals = GUI_piers()
    ...
    fig = uifigure('Name', 'Enter Parameters', 'Position', [100, 100, 300, 310]);
    labels = {'pH1', 'pH2', 'A', 'BA1', 'BA2', 'C'};
    n = numel(labels);
    fields = gobjects(n,1);

    for i = 1:n
        uilabel(fig, 'Text', labels{i}, 'Position', [30, 320-40*i, 60, 22]);
        fields(i) = uieditfield(fig, 'numeric', 'Position', [100, 320-40*i, 150, 22]);
    end
