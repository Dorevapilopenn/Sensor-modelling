...
CONFIG = {
    ...
    "datasets": {
        "U": "gitignored_data/Ms_res9U.csv",
    },
    ...
    "stratcorrs": [
        ("{key}_corr_deltaD_deltaK_Et_vs_deltaG.png", "deltaD", "deltaK", "Et", "deltaG"),
        ("{key}_corr_deltaC_deltaG_Et_vs_deltaK.png", "deltaC", "deltaG", "Et", "deltaK"),
        ("{key}_stratcorr_deltaC_deltaG_Et_vs_deltaD.png", "deltaC", "deltaG", "Et", "deltaD"),
        ("{key}_stratcorr_deltaD_deltaC_Et_vs_deltaG.png", "deltaD", "deltaC", "Et", "deltaG"),
        ("{key}_stratcorr_deltaG_deltaD_Et_vs_deltaC.png", "deltaG", "deltaD", "Et", "deltaC"),
        ("{key}_stratcorr_deltaC_deltaG_Et_vs_K1.png", "deltaC", "deltaG", "Et", "K1"),
        ("{key}_stratcorr_deltaK_deltaG_Et_vs_K1.png", "deltaK", "deltaG", "Et", "K1"),
        ("{key}_stratcorr_deltaD_deltaC_Et_vs_deltaK.png", "deltaD", "deltaC", "Et", "deltaK"),
        ("{key}_stratcorr_deltaD_deltaC_Et_vs_K1.png", "deltaD", "deltaC", "Et", "K1"),
    ],
    "mean_matrix": {
