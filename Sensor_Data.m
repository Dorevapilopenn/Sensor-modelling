clear, clc, close all
spec_names = {'H' 'G' 'D' 'HG' 'HD'  'GD'};
Model      = [ 1   0   0    1    1    0; ...  % H
               0   1   0    1    0    1; ...  % G
               0   0   1    0    1     1];     % D
log_beta   = [ 0   0   0  6.25  5.2  4];
...
Model      = [ 1   0   0    1    1    0; ...  % H
               0   1   0    1    0    1; ...  % G
               0   0   1    0    1     1];     % D
log_beta   = [ 0   0   0  5.1  4.5  5];
% log_beta   = [ 0   0   0  6.1  5.5  4.2];
...
D_arr1=[D_meas1 D_meas2];
save D:/Sens1.mat D_arr1