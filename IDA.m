...
% Create a tiled layout (2x2) with compact spacing.
...
for p=1:1
    ...
    nsamp=50;
    c_0     = [16.5e-6 0.000001 16.5e-6];  % tot conc in initial solution Bi,Cl
    ncomp   = length(c_0);   
    C_f = cell(1,2); 
    for i=1:2
    ...
    C_colored = [C_C{1}; C_C{3}; C_C{2}; C_C{4}]
